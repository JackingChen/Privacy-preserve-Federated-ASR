...
class Model(SingleForwardModel):
    ...
    def preprocess_dataframe(self):
        ...
        df_train = pd.read_pickle(f"{self.inpArg.file_in}/train.pkl")
        df_dev = pd.read_pickle(f"{self.inpArg.file_in}/dev.pkl")
        df_test = pd.read_pickle(f"{self.inpArg.file_in}/test.pkl")
