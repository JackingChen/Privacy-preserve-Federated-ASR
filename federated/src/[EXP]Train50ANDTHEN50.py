...
def stage3_training_5050(args, train_dataset, test_dataset):# use number of global epoch for global model
...
if __name__ == '__main__':
    ...
    if args.EXTRACT != True:                                                        # Training
        if args.FL_STAGE == 1:
            ...
            stage1_training_5050(args, train_dataset_supervised, test_dataset)                      # Train ASR & AD Classifier
            print("| 50-50 Training Stage 1 Done|")
        elif args.FL_STAGE == 2:
            args.STAGE = 1
            print("| Start 50-50 Training Stage 2|")
            stage2_training_5050(args, train_dataset_supervised, test_dataset)                      # Train ASR & AD Classifier
